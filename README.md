...
=============================================
# NOTE: The Google Analytics UA View will be turned off June 2023, use my other github project which uses the newer GA4 model and Analytics Data API v1, [ga4-py3-page-growth-trend](https://github.com/fabianlee/ga4-py3-page-growth-trend) or [ga4-pandas-py3-page-growth-trend](https://github.com/fabianlee/ga4-pandas-py3-page-growth-trend)
=============================================
